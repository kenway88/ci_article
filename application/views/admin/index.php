...
<!-- 头部 -->
	<div id="top_box">
		<div id="top">
			<p id="top_font">文章系统后台管理首页 （V1.1）</p>
		</div>
		<div class="top_bar">
			<p class="adm">
				<span>管理员：</span>
		...
		<div id="left_box">
			...
			<div class="menu_box">
				...
				<div class="text">
					...
					<ul class="con">
				        <li class="nav_u">
				        	<a href="<?php echo site_url('admin/article/index') ?>" class="pos">查看文章</a>				        	
				        </li> 
				    </ul>
			...
			<div class="menu_box">
				...
				<div class="text">
					<ul class="con">
				        <li class="nav_u">
				        	<a href="<?php echo site_url('admin/category/index') ?>" class="pos">查看应用</a>
				        </li> 
				    </ul>
				  	<ul class="con">
				        <li class="nav_u">
				        	<a href="<?php echo site_url('admin/category/add_app') ?>" class="pos">添加应用</a>
				        </li> 
				    </ul>
				</div>
			</div>	
